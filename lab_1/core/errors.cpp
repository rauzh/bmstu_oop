...
void HandleError(const result_t &error)
{
    ...
    switch (error)
    {
        ...
        case INCORRECT_POINTS_COUNT:
            ...
            message_box.setFixedSize(MESSAGE_BOX_SIZE_X, MESSAGE_BOX_SIZE_Y);
            break;
        case INCORRECT_BINDINGS_COUNT:
            message_box.critical(0, "Error","The number of bindings in the file is not correct.");
            message_box.setFixedSize(MESSAGE_BOX_SIZE_X, MESSAGE_BOX_SIZE_Y);
            break;
        case INCORRECT_POINT_DATA:
            ...
            message_box.setFixedSize(MESSAGE_BOX_SIZE_X, MESSAGE_BOX_SIZE_Y);
            break;
        case INCORRECT_BINDING_DATA:
            message_box.critical(0, "Error","The point bindings in the file are not correct.");
            message_box.setFixedSize(MESSAGE_BOX_SIZE_X, MESSAGE_BOX_SIZE_Y);
            break;
        default:
